...
public class BigMetasFuerzaComercialDto {
	
	private Date D_fecha;
	private Date I_cod_fuerza_comercial;
	...
	public Date getI_cod_fuerza_comercial() {
		return I_cod_fuerza_comercial;
	}

	public void setI_cod_fuerza_comercial(Date i_cod_fuerza_comercial) {

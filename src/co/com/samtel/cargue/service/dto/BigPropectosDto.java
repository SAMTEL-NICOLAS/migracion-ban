...
public class BigPropectosDto {
	...
	public void setS_codigo_tipo_identificacion(String s_codigo_tipo_identificacion) {
		S_codigo_tipo_identificacion = s_codigo_tipo_identificacion;
	}
	public Integer getS_numero_identificacion() {
		return S_numero_identificacion;
	}
	public void setS_numero_identificacion(Integer s_numero_identificacion) {
		S_numero_identificacion = s_numero_identificacion;
	}
	public String getS_nombre_completo() {
		return S_nombre_completo;
	}
	public void setS_nombre_completo(String s_nombre_completo) {
		S_nombre_completo = s_nombre_completo;
	}
	...
	public void setI_posecion_negocio_mes(Integer i_posecion_negocio_mes) {
		I_posecion_negocio_mes = i_posecion_negocio_mes;
	}
	...
	public void setI_codigo_ejecutivo(String i_codigo_ejecutivo) {
		I_codigo_ejecutivo = i_codigo_ejecutivo;
	}
	...
	public void setI_codigo_asesor_geo(String i_codigo_asesor_geo) {
		I_codigo_asesor_geo = i_codigo_asesor_geo;
	}
	...
	public void setS_cod_sector_economico(String s_cod_sector_economico) {
		S_cod_sector_economico = s_cod_sector_economico;
	}
	...
	public void setM_total_activos(BigDecimal m_total_activos) {
		M_total_activos = m_total_activos;
	}
	...
	public void setI_cod_tipo_direccion(String i_cod_tipo_direccion) {
		I_cod_tipo_direccion = i_cod_tipo_direccion;
	}
	...
	public void setI_cod_clasifica_direccion(String i_cod_clasifica_direccion) {
		I_cod_clasifica_direccion = i_cod_clasifica_direccion;
	}
	...
	public void setI_cod_departamento_cap(String i_cod_departamento_cap) {
		I_cod_departamento_cap = i_cod_departamento_cap;
	}
	...
	public void setS_direccion_predio_cap(String s_direccion_predio_cap) {
		S_direccion_predio_cap = s_direccion_predio_cap;
	}
	...
	public void setS_estado_georeferencia(String s_estado_georeferencia) {
		S_estado_georeferencia = s_estado_georeferencia;
	}
	...
	public void setI_codigo_postal(Integer i_codigo_postal) {
		I_codigo_postal = i_codigo_postal;
	}
	...
	public void setS_referencia_direccion(String s_referencia_direccion) {
		S_referencia_direccion = s_referencia_direccion;
	}
	...
	public String toString() {
		return "BigPropectosDto [S_tipo_cliente=" + S_tipo_cliente + ", S_codigo_tipo_identificacion="
				+ S_codigo_tipo_identificacion + ", S_numero_identificacion=" + S_numero_identificacion
				+ ", S_nombre_completo=" + S_nombre_completo + ", I_posecion_negocio_mes=" + I_posecion_negocio_mes
				+ ", I_cod_fuerza_comercial=" + I_cod_fuerza_comercial + ", I_codigo_ejecutivo=" + I_codigo_ejecutivo
				+ ", I_codigo_asesor_geo=" + I_codigo_asesor_geo + ", S_cod_sector_economico=" + S_cod_sector_economico
				+ ", S_cod_interno_actividad_economica=" + S_cod_interno_actividad_economica + ", I_agencia_creacion="
				+ I_agencia_creacion + ", I_codigo_segmento=" + I_codigo_segmento + ", I_codigo_sub_segmento="
				+ I_codigo_sub_segmento + ", S_telefono_movil=" + S_telefono_movil + ", S_sexo=" + S_sexo
				+ ", D_fecha_nacimiento=" + D_fecha_nacimiento + ", I_edad=" + I_edad + ", M_total_activos="
				+ M_total_activos + ", I_cod_tipo_direccion=" + I_cod_tipo_direccion + ", I_cod_clasifica_direccion="
				+ I_cod_clasifica_direccion + ", I_cod_departamento_cap=" + I_cod_departamento_cap
				+ ", I_cod_municipio_cap=" + I_cod_municipio_cap + ", I_cod_barrio_cap=" + I_cod_barrio_cap
				+ ", S_direccion_predio_cap=" + S_direccion_predio_cap + ", S_estado_georeferencia="
				+ S_estado_georeferencia + ", S_direccion_predio_geo=" + S_direccion_predio_geo + ", I_cod_localidad="
				+ I_cod_localidad + ", I_cod_barrio_geo=" + I_cod_barrio_geo + ", I_cod_oficina_geo="
				+ I_cod_oficina_geo + ", I_cod_zona_geo=" + I_cod_zona_geo + ", I_cod_subzona_geo=" + I_cod_subzona_geo
				+ ", F_coord_x=" + F_coord_x + ", F_coord_y=" + F_coord_y + ", I_codigo_postal=" + I_codigo_postal
				+ ", S_referencia_direccion=" + S_referencia_direccion + ", S_canal_vinculacion=" + S_canal_vinculacion
				+ ", I_numero_carpeta=" + I_numero_carpeta + ", D_fecha_cargue=" + D_fecha_cargue
				+ ", D_fecha_consulta=" + D_fecha_consulta + ", S_interesado=" + S_interesado + ", S_producto="
				+ S_producto + "]";
	}

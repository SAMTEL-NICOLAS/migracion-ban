...
@Stateless(name = "bigClienteEstadosMigrateHiloUno")
public class BigClienteEstadosMigrateHiloUno extends MigrateAbs<BigClienteEstadosAs, BigClienteEstados>
		implements IGenerateMigration, ITransformation, Runnable{

	@EJB(beanName = "bigClienteEstadosAsDaoUno")
	IGenericDao origen;

	@EJB(beanName = "bigClienteEstadosDaoUno")
	IGenericDao destino;

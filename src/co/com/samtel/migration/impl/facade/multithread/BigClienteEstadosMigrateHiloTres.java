...
@Stateless(name = "bigClienteEstadosMigrateHiloTres")
public class BigClienteEstadosMigrateHiloTres extends MigrateAbs<BigClienteEstadosAs, BigClienteEstados>
		implements IGenerateMigration, ITransformation,Runnable {

	@EJB(beanName = "bigClienteEstadosAsDaoTres")
	IGenericDao origen;

	@EJB(beanName = "bigClienteEstadosDaoCuatro")
	IGenericDao destino;

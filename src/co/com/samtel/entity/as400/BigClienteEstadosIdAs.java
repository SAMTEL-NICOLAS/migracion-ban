...
@Embeddable
public class BigClienteEstadosIdAs implements Serializable {
	...
	public BigClienteEstadosIdAs() {
		super();		
	}

	public BigClienteEstadosIdAs(Long i_identificador_cliente, Date d_fecha_corte) {
		super();
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		BigClienteEstadosIdAs other = (BigClienteEstadosIdAs) obj;

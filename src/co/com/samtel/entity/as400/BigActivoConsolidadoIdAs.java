...
@Embeddable
public class BigActivoConsolidadoIdAs implements Serializable {
	...
	public BigActivoConsolidadoIdAs() {
		super();	
	}

	public BigActivoConsolidadoIdAs(Long i_identificacion_cliente, String s_cod_producto, Date d_fecha_corte) {
		super();
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		BigActivoConsolidadoIdAs other = (BigActivoConsolidadoIdAs) obj;

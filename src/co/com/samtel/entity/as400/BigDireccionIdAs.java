...
@Embeddable
public class BigDireccionIdAs implements Serializable {
	...
	@Column(name = "tip_direcc")
	private String s_cod_tipo_direccion;

	public BigDireccionIdAs() {
		super();		
	}

	public BigDireccionIdAs(Long i_identificacion_cliente, String s_cod_tipo_direccion) {
		super();
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		BigDireccionIdAs other = (BigDireccionIdAs) obj;

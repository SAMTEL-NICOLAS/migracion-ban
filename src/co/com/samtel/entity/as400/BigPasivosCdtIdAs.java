...
@Embeddable
public class BigPasivosCdtIdAs implements Serializable {
	
	private static final long serialVersionUID = 1L;

	@Column(name = "numero_cdt")
	private Long i_portafolio;
	
	@Transient
	private Date d_fecha_cierre;

	public BigPasivosCdtIdAs() {
		super();
		
	}

	public BigPasivosCdtIdAs(Long i_portafolio, Date d_fecha_cierre) {
		super();
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		BigPasivosCdtIdAs other = (BigPasivosCdtIdAs) obj;

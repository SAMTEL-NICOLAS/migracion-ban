...
@Embeddable
public class BigPasivosAhIdAs implements Serializable {
	...
	public BigPasivosAhIdAs() {
		super();	
	}

	public BigPasivosAhIdAs(Long i_codigo_cuenta, Date d_fecha_corte) {
		super();
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		BigPasivosAhIdAs other = (BigPasivosAhIdAs) obj;

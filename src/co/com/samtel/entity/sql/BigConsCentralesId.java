...
@Embeddable
public class BigConsCentralesId implements Serializable{
	...
	public BigConsCentralesId() {
		super();
	}
	
	public BigConsCentralesId(Long i_prod_onbase, Long i_identificacion_cliente) {
		super();
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		BigConsCentralesId other = (BigConsCentralesId) obj;

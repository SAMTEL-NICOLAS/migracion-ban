...
@Embeddable
public class BigClienteEstadosId implements Serializable {
	...
	public BigClienteEstadosId() {
		super();	
	}

	public BigClienteEstadosId(Long i_identificador_cliente, Date d_fecha_corte) {
		super();
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		BigClienteEstadosId other = (BigClienteEstadosId) obj;

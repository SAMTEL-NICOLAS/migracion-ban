...
@Embeddable
public class BigLocalidadId implements Serializable {
	...
	public BigLocalidadId() {
		super();
		
	}

	public BigLocalidadId(String i_cod_depto, String s_cod_ciudad, String i_cod_localidad) {
		super();
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		BigLocalidadId other = (BigLocalidadId) obj;
		if (i_cod_depto == null) {

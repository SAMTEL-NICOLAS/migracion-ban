...
public class BigCalificacionCarteraCliente implements Serializable {
	...
	public BigCalificacionCarteraClienteId getId() {
		return id;
	}

	public void setId(BigCalificacionCarteraClienteId id) {
		this.id = id;
	}

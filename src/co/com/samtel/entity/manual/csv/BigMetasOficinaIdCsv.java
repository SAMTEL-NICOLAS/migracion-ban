 ...
 */
@Embeddable
public class BigMetasOficinaIdCsv implements Serializable {
	...
	public BigMetasOficinaIdCsv() {
		super();
	}

	public BigMetasOficinaIdCsv(String s_cod_oficina, Integer i_cod_segmento_producto, String s_nombre_meta,
			Date d_fecha) {
		super();
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		BigMetasOficinaIdCsv other = (BigMetasOficinaIdCsv) obj;
		if (d_fecha == null) {

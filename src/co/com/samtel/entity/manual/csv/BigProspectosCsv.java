...
public class BigProspectosCsv implements Serializable {

	private static final long serialVersionUID = 1L;
	
	@EmbeddedId
	private BigProspectosIdCsv id;	
	...
	public BigProspectosIdCsv getId() {
		return id;
	}

	public void setId(BigProspectosIdCsv id) {
		this.id = id;
	}

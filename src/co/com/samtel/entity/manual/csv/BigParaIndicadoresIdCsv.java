 ...
 */
@Embeddable
public class BigParaIndicadoresIdCsv implements Serializable {
	...
	public BigParaIndicadoresIdCsv() {
		super();
	}

	public BigParaIndicadoresIdCsv(Integer i_id_indicador, Date d_fecha_fin, Date d_fecha_inicio) {
		super();
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		BigParaIndicadoresIdCsv other = (BigParaIndicadoresIdCsv) obj;
		if (d_fecha_fin == null) {

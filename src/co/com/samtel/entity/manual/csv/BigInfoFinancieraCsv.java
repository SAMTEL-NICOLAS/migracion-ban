...
*/
@Entity
@Table(name = "Big Info Financiera")
public class BigInfoFinancieraCsv implements Serializable {

	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private BigInfoFinancieraIdCsv id;
	...
	public BigInfoFinancieraIdCsv getId() {
		return id;
	}

	public void setId(BigInfoFinancieraIdCsv id) {
		this.id = id;
	}

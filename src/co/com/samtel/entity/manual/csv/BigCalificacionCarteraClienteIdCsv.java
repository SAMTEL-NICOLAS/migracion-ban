 ...
 */
@Embeddable
public class BigCalificacionCarteraClienteIdCsv implements Serializable {
	...
	public BigCalificacionCarteraClienteIdCsv() {
		super();
	}

	public BigCalificacionCarteraClienteIdCsv(String i_codigo_cliente, Long i_cod_operacion, Date d_fecha_carga) {
		super();
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		BigCalificacionCarteraClienteIdCsv other = (BigCalificacionCarteraClienteIdCsv) obj;

...
@Stateless(name="bigClienteEstadosDaoTres")
public class BigClienteEstadosDaoTres extends AbsDao<BigClienteEstados, BigClienteEstadosId,DummyConsecutivo> implements IBigClienteEstadosDao {
